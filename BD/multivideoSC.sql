...
/* Trigger structure for table `rentas` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Insertar_Compras` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `Insertar_Compras` AFTER INSERT ON `rentas` FOR EACH ROW BEGIN
	
	/*IF NOT EXISTS (SELECT idrenta FROM compras order by idrenta desc limit 1) THEN*/
		INSERT INTO compras (idrenta, idproducto, nombre_pelicula, cantidad_renta, cantidad_producto, cantidad_pelicula, fecha, total)
			SELECT idrenta, NULL, nombre_peli, 1, NULL, NULL, fechainicio, precio
				FROM rentas, peliculas WHERE nombre_peli=nombre order by idrenta desc limit 1;
	/*END IF;*/
