...
public class PeliculasRentadas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPelisDisponibles = new javax.swing.JButton();
        ...
        btnPelisDisponibles.setText("Buscar");
        btnPelisDisponibles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPelisDisponiblesActionPerformed(evt);
            }
        });

        jButton2.setText("Crear renta");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btnPelisDisponibles, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnPelisDisponiblesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPelisDisponiblesActionPerformed
        //Mostrar en la lista las peliculas disponibles
        try{
            String qMostrarPelis = "SELECT * FROM peliculas WHERE stock >= 0";
            ...
            while (resQuery.next()){
                String peliNombre = resQuery.getString("nombre"); //get the element in column "item_code"
                listaPelis.addElement(peliNombre); //add each item to the model
            }
            lstPeliculas.setModel(listaPelis);
    ...
    private javax.swing.JButton btnPelisDisponibles;
